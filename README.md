...
## Misc
* [AutoEQ](https://github.com/jaakkopasanen/AutoEq/tree/master/results/oratory1990/harman_over-ear_2018/Philips%20Fidelio%20X2HR) - Provides EQ settings for various headphones to give them a more neutral profile (ie match the [Harman Target Curve](https://audiosolace.com/2021/05/23/harman-target-curve-explained/#:~:text=The%20Harman%20target%20curve%20is%20a%20rough%20approximation%20of%20what,specialized%20equipment%20to%20measure%20it.)). Combine with EQ software such as EqualizerAPO (for best results, use [GraphicEQ](https://github.com/jaakkopasanen/AutoEq#equalizerapo)).
